package com.fans.dao.redis.impl;
...
import com.fans.dao.AbstractBaseRedisDao;
import com.fans.dao.redis.RedisDao;
import com.fans.common.util.DbFH;
...
public class RedisDaoImpl extends AbstractBaseRedisDao<String, PageData> implements RedisDao{
	...
	/**删除
	 * (non-Javadoc)
	 * @see com.fans.dao.redis.RedisDao#delete(String)
	 */
	@Override
	...
	/**删除多个
	 * (non-Javadoc)
	 * @see com.fans.dao.redis.RedisDao#delete(List)
	 */
	@Override
	...
	/**修改
	 * (non-Javadoc)
	 * @see com.fans.dao.redis.RedisDao#eidt(String, String)
	 */
	@Override
	...
	/**通过key获取值
	 * (non-Javadoc)
	 * @see com.fans.dao.redis.RedisDao#get(String)
	 */
	@Override
	...
	public Properties getPprVue(){
		InputStream inputStream = DbFH.class.getClassLoader().getResourceAsStream("resource/redis.properties");
